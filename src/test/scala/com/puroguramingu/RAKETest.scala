...
class RAKETest extends FunSuite {
  ...
  test("Should rank keywords by degree") {
    val rake = new RAKE(stopwords, Array(' ', '\t'), Array('.', ',', '\n'))
    val rankedKeywords = rake.toScoredKeywords(bookDoc)
    ...
    val expectedScores = Map(ListBuffer("used") -> 1.0, ListBuffer("considered") -> 3.0,
      ...
      ListBuffer("compatibility") -> 4.0, ListBuffer("set") -> 6.0,
      ListBuffer("components") -> 1.0, ListBuffer("algorithms") -> 3.0,
      ListBuffer("given") -> 1.0, ListBuffer("criteria") -> 3.0, ListBuffer("solving") -> 1.0,
      ...
      ListBuffer("minimal", "set") -> 14.0,
      ListBuffer("these", "criteria") -> 5.0, ListBuffer("types") -> 5.0,
      ListBuffer("solutions") -> 9.0, ListBuffer("construction") -> 1.0)

    assertResult(27)(rankedKeywords.size)
    assertResult(expectedScores)(rankedKeywords)
  }

  test("Should rank keywords by frequency") {
    val rake = new RAKE(stopwords, Array(' ', '\t'), Array('.', ',', '\n'))
    val rankedKeywords = rake.toScoredKeywords(bookDoc, RAKEStrategy.Freq)
    ...
    val expectedScores = Map(ListBuffer("used") -> 1.0, ListBuffer("considered") -> 2.0,
      ...
      ListBuffer("compatibility") -> 4.0, ListBuffer("set") -> 3.0, ListBuffer("components") -> 1.0,
      ListBuffer("algorithms") -> 2.0, ListBuffer("given") -> 1.0, ListBuffer("criteria") -> 2.0,
      ...
      ListBuffer("these", "criteria") -> 3.0, ListBuffer("types") -> 3.0,
      ListBuffer("solutions") -> 9.0, ListBuffer("construction") -> 1.0)
  ...
  test("Should rank keywords by degree/frequency ration") {
    val rake = new RAKE(stopwords, Array(' ', '\t'), Array('.', ',', '\n'))
    val rankedKeywords = rake.toScoredKeywords(bookDoc, RAKEStrategy.Ratio)
    ...
    val expectedScores = Map(ListBuffer("used") -> 1.0, ListBuffer("considered") -> 1.5,
      ...
      ListBuffer("constructing") -> 1.0, ListBuffer("compatibility") -> 2.0,
      ListBuffer("set") -> 2.0, ListBuffer("components") -> 1.0, ListBuffer("algorithms") -> 1.5,
      ListBuffer("given") -> 1.0, ListBuffer("criteria") -> 1.5, ListBuffer("solving") -> 1.0,
      ...
      ListBuffer("minimal", "set") -> 4.666666666666666,
      ListBuffer("these", "criteria") -> 3.5, ListBuffer("types") -> 1.6666666666666667,
